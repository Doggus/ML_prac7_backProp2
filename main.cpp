   ...
   vector<neuron> inputLayer = 
	{
		...
		neuron(XORdata[0].input2, vector<float> {getRandomFloat(-1,1), getRandomFloat(-1,1), getRandomFloat(-1,1)}),
		neuron(XORdata[0].input3, vector<float> {getRandomFloat(-1,1), getRandomFloat(-1,1), getRandomFloat(-1,1)}),
